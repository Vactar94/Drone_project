...
class Screen_Info_Drone(Screen_sous_menu):
    ...
    def __init__(self, **kw):
        ...
        pos_hint_titre_drone = {"center_x": 0.5, "center_y": 0.625}  # Position du app.info_drone_screen.drone.titre
        pos_hint_box_temph = {"center_x": 0.5, "center_y": 0.55}  # Position de l'info temph
        pos_hint_box_batt = {"center_x": 0.5, "center_y": 0.5}  # Position de l'info de battery

        # ----------------------- titre Drone : ----------------------- #

        titre_drone = Updatable_Label(id_text="app.info_drone_screen.drone.titre", pos_hint=pos_hint_titre_drone,
                                      color=(0, 0, 0, 1), font_size_type="titre")
        ...
        titre_temph = Updatable_Label(id_text="app.info_drone_screen.drone.temph.titre",
                                      pos_hint={"center_x": 0.3, "center_y": 0.5}, color=(0, 0, 0, 1))
        ...
        def update_var_temph() -> str:
            ...
            if DRONE.is_connected:
                ...
                return "app.drone.not_connected"
        ...
        titre_batt = Updatable_Label(id_text="app.info_drone_screen.drone.batt.titre",
                                     pos_hint={"center_x": 0.3, "center_y": 0.5}, color=(0, 0, 0, 1))
